...
public class ShowcaseView extends RelativeLayout implements
	...
	public ShowcaseView(Context context, AttributeSet attrs, int defStyle) {
		...
		mShowCaseColor = styled.getInt(R.styleable.ShowcaseView_sv_color,
		...
		AnimationUtils.createFadeInAnimation(this,
				new AnimationStartListener() {
					...
					public void onAnimationStart() {
						...
						if (mEventListener != null) {
							mEventListener
									.onShowcaseViewShow(ShowcaseView.this);
						}
					}
				}).start();
	}
	...
	public void setColor(String hexColorString) {
		mShowCaseColor = Color.parseColor(hexColorString);
		invalidate();
	}

	public void setColor(int colorResId) {
		mShowCaseColor = getContext().getResources().getColor(colorResId);
		invalidate();
	}
